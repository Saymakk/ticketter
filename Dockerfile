...
ARG NEXT_PUBLIC_HEALTHY_LIFE_VAPID_PUBLIC_KEY
# SKIP_PWA_BUILD=1 — быстрее на слабом VPS, но без service worker пуши не работают.
ARG SKIP_PWA_BUILD=
...
ENV NEXT_PUBLIC_HEALTHY_LIFE_VAPID_PUBLIC_KEY=$NEXT_PUBLIC_HEALTHY_LIFE_VAPID_PUBLIC_KEY
ENV SKIP_PWA_BUILD=$SKIP_PWA_BUILD
